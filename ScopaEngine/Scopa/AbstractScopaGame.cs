...
namespace NIESoftware.Scopa {
    ...
    abstract class AbstractScopaGame {

        private int winningScore;
        protected List<IScopaPlayer> players;
        protected List<Card> table;
        protected Deck deck;
        protected int currentDealer;
        protected int currentPlayer;
        private IScopaPlayer lastTrick;
        private PlayerActions possibleActions;

        protected AbstractScopaGame(int requiredPoints) {
            winningScore = requiredPoints;
            players = new List<IScopaPlayer>();
            table = new List<Card>();
            deck = NewDeck;
        }

        public abstract void DealStartingHand();
        ...
        public List<IScopaPlayer> Players {
            get { return new List<IScopaPlayer> (players); }
        }
        ...
        public List<Card> Table {
            get { return new List<Card> (table); }
        }
        ...
        public PlayerActions PossibleActions {
        ...
        public bool IsInProgress {
            get { return (players.Any<IScopaPlayer>(a => a.Hand.Count > 0) || players.Any<IScopaPlayer>(a => a.Points > 0)); }
        }
        ...
        public void BeginGame() {
            ...
            possibleActions = new PlayerActions();
            DealStartingHand();
        }
